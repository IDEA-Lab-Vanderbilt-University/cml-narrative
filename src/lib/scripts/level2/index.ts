...
const script: Script = {
	lines: [
        ...
        },
        {
            ...
            avatars: [ '/img/characters/bot-buddy/bot-buddy-happy.png', '/img/characters/level-2/robot/robot_happy-removebg-preview.png'],
            background: '/img/backgrounds/level2/showroom.png',
        ...
        },
        {
            ...
            avatars: ['/img/characters/bot-buddy/bot-buddy-happy.png'],
            background: '/img/backgrounds/level2/factoryfloor.png',
