...
const script: Script = {
	lines: [
		...
		},
		{
			...
			speaker: 'Agent Fern',
			dialog:
				"Great to see you, Captain Storm! Welcome, [AGENT NAME]! I can't wait to tell you about Bot Buddy!",
		...
		},
		{
			...
			speaker: 'Agent Fern',
			dialog:
				'Your Bot Buddy will be your companion during this mission. Bot Buddies can provide clues and receive directions form Mission Control.',
		...
		},
		{
			...
			speaker: 'Agent Gear',
			dialog:
				'I have them, Captain Storm! Sorry I was late, I wanted our new agent to have all the options to choose from!',
		...
		},
		{
			...
			speaker: 'Agent Gear',
			dialog:
				'[AGENT NAME], please choose the Bot Buddy you want to accompany you on your mission to the future.',
		...
		},
		{
			...
			speaker: 'Agent Gear',
			dialog:
				'All of the Bot Buddies have the same abilities so you can choose the one tou like best!',
