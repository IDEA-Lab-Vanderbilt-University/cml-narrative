...
const script: Script = {
	lines: [
		...
		},
		{
			...
			avatars: [],
			background: '',
			audio: '/level4new/sample_robots/agent_1_l4s8.mp3',
		},
		{
			id: 9,
			speakers: [getCharacterName(currentLanguage, 'spotTablet')],
			...
			avatars: [],
			background: '',
			audio: '/level4new/sample_robots/agent_1_l4s9.mp3',
		},
		{
			id: 10,
			speakers: [getCharacterName(currentLanguage, 'spotTablet')],
			...
			avatars: [],
			background: '',
			audio: '/level4new/sample_robots/agent_2_l4s10.mp3',
		},
		{
			id: 11,
		...
		},
		{
			...
			avatars: [],
			background: '',
			audio: '/level4new/sample_robots/agent_3_l4s12.mp3',
		},
		{
			id: 13,
			speakers: [getCharacterName(currentLanguage, 'spotComputer')],
		...
		},
		{
			id: 35,
			speakers: [getCharacterName(currentLanguage, 'captainStorm')],
			dialog: () => getScriptTranslationWithFallback(currentLanguage as any, 'level4new', 'main', 35, { agentName: agent.agent_name || 'Agent' }),
