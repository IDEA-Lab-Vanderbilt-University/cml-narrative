			...
			<Tablet>
                ...
                <div
                    ...
                    <div class="hud-red-blue-border flex w-3/4 flex-col space-y-4 p-4 text-3xl" id="options">
                        <SurveyOption emoji="=ƒÿâ" response="Strongly Agree" on:click={() => handleSelection('Strongly Agree')} bind:this={strongAgreeElement} />
                        <SurveyOption emoji="=ƒÖé" response="Agree" on:click={() => handleSelection('Agree')} bind:this={agreeElement} />
                        <SurveyOption emoji="=ƒÿÉ" response="Neutral" on:click={() => handleSelection('Neutral')} bind:this={neutralElement} />
                        <SurveyOption emoji="=ƒÖü" response="Disagree" on:click={() => handleSelection('Disagree')} bind:this={disagreeElement} />
                        <SurveyOption emoji="Gÿ¦n+Å" response="Strongly Disagree" on:click={() => handleSelection('Strongly Disagree')} bind:this={strongDisagreeElement} />
                    </div>
